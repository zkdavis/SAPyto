...
nuFnu_lc = LC.integ(9e11, 2e12, numt, nu_obs, nu_obs * Fnu)
...
ax.plot(t_obs, nuFnu_lc)
ax.plot(t_obs, nuFnu_lc_mono)
ax.plot(t_obs, nuFnu_lc_near)
ax.plot(t_obs, nuFnu_lc_pwl, ls='--')
